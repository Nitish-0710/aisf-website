...
function App() {
  ...
  const galleryImages = [
    "./gallery/OAK_7002.JPG",
    "./gallery/OAK_7003.JPG",
    "./gallery/OAK_7031.JPG",
    "./gallery/OAK_7049.JPG",
    "./gallery/OAK_7075.JPG",
    "./gallery/OAK_7095.JPG",
    "./gallery/OAK_7128.JPG",
    "./gallery/OAK_7143.JPG",
  ];
      ...
      <main>
        ...
        <header className="navbar">
          <div className="nav-logo">
            <img src="./aisf-logo.png" alt="AISF Logo" className="logo-img" />
          </div>
        ...
        <section id="home" className="hero">
          ...
          <section className="downloads-section">
            ...
            <div className="download-grid">
              ...
              <a
                href="./CODEAPEX_Problem Statements.pdf"
                download
                className="download-card"
              >
                <span className="download-icon">📄</span>
              ...
              <a
                href="./Participants Handbook - AISF_ CODE APEX 2.0.pdf"
                download
                className="download-card"
              >
                <span className="download-icon">📘</span>
