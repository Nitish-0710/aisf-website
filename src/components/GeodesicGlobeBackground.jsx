...
export default function GeodesicGlobeBackground() {
  ...
  useEffect(() => {
    ...
    const renderer = new THREE.WebGLRenderer({
      alpha: true,
      antialias: !isMobile && window.devicePixelRatio < 2, // Disable MSAA on retina or mobile
      powerPreference: "high-performance",
      precision: isMobile ? "mediump" : "highp",
      depth: false, // Disables 24-bit Z-buffer allocation (saves 20-30MB VRAM)
      stencil: false, // Disables 8-bit Stencil buffer allocation (saves 10MB VRAM)
    });
    ...
    // 8. High-Efficiency Animation Loop with Visibility Optimization
    ...
    const animate = () => {
      ...
      if (!isVisible) return; // Zero GPU & RAM work when tab is inactive
