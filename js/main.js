...
(function () {
  ...
  const teamMembers = [
    // 1. FACULTY MENTORS & ADVISORS (FIRST)
    {
      ...
      institution: 'Dept. of CSE (Artificial Intelligence) · VIT Pune',
    ...
    // 2. CORE EXECUTIVE BOARD (SECOND)
    {
      ...
      institution: 'Dept. of CS (Artificial Intelligence) · VIT Pune',
